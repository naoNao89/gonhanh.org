...
# Run: powershell -ExecutionPolicy Bypass -File util/setup-windows.ps1
...
Write-Host "Run 'util/build-core-windows.ps1' to build the Rust core library." -ForegroundColor Cyan
