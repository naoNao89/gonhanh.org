...
use crate::buffer::{Buffer, Char, MAX};
use crate::input::{self, ToneType};
use crate::shortcut::{InputMethod, ShortcutTable};
use crate::syllable;
use crate::utils;
use crate::validation::{
    self, is_foreign_word_pattern, is_valid, is_valid_for_transform_with_foreign,
...
impl Engine {
    ...
    fn vowels_form_valid_diphthong(&self, vowels: &[Vowel]) -> bool {
        use data::vowel::{TONE_FIRST_PATTERNS, TONE_SECOND_PATTERNS};
    ...
    fn reorder_diphthong_with_final(&mut self) -> Option<usize> {
        use data::constants::VALID_FINALS_1;
